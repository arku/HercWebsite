        ...
        <div class="columns blurbs-holder">
          <div class="column blurb">
            <img src="../../assets/bubble/Icon4_Game.png" class="hvr-pulse-shrink">
              <p> HIPR is built with Unity3D, with C# for gameplay and Solidity for smart contracts. It targets 
                WebGL thanks to emscripten and WASM and it interacts with smart contracts with Web3 library.
